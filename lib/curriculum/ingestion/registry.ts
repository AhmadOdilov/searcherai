...
export const CURRICULUM_SUBJECT_REGISTRY: Record<string, SubjectRegistryEntry> = {
  Matematika: {
    ...
    status: "OFFICIAL",
    officialSourceUrl: "https://uzbmb.uz/upload/file/pdf/qabul2025/dasturlar/2.Matematika/",
    curriculumYear: 2025,
    sourceVersion: "DTS-UZBMB-2025-v1",
    sourceUpdatedAt: "2025-01-15T00:00:00.000Z",
    authorizedAuthority: "O'zbekiston Respublikasi Maktabgacha va maktab ta'limi vazirligi / Bilimni baholash agentligi",
    gradesAvailable: ["5-sinf", "6-sinf", "7-sinf", "8-sinf", "9-sinf", "10-sinf", "11-sinf"],
  },
  "Ona tili": {
    subject: "Ona tili",
    ...
    status: "OFFICIAL",
    officialSourceUrl: "https://uzbmb.uz/upload/file/pdf/qabul2025/dasturlar/1.Ona%20tili%20va%20adabiyot/",
    curriculumYear: 2025,
    sourceVersion: "DTS-UZBMB-2025-v1",
    sourceUpdatedAt: "2025-01-15T00:00:00.000Z",
    authorizedAuthority: "O'zbekiston Respublikasi Maktabgacha va maktab ta'limi vazirligi / Bilimni baholash agentligi",
 ...
 */
export function getSubjectCurriculumStatus(subjectName: string): SubjectRegistryEntry | null {
